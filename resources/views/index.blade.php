					...
					<div class="col-xl-12">
					  <div class="card-body p-0">
						<ul class="balance-data"> 
						  ...
						  <li><span class="circle bg-primary"> </span><span class="f-light ms-1">Admins</span></li>
						</ul>
			...
			<ul> 
			  <li class="d-flex">
				...
				<div class="w-100 ms-3">
				  <p class="d-flex justify-content-between mb-2"><span class="date-content light-background">13th March, 2024 </span><span>1:00 PM</span></p>
				  <h6>Pending Contract<span class="dot-notification"></span></h6>
				  <p class="f-light">Each of the results is important...</p>
				</div>
			  </li>
			  <li class="d-flex">
				<div class="activity-dot-warning"></div>
				<div class="w-100 ms-3">
				  <p class="d-flex justify-content-between mb-2"><span class="date-content light-background">12th March, 2024 </span><span>Yesterday</span></p>
				  <h6>Requesting Contract<span class="dot-notification"></span></h6>
				  <p>Each of the results is important... </p>
				</div>
			  </li>
			  <li class="d-flex">
				<div class="activity-dot-secondary"></div>
				<div class="w-100 ms-3">
				  <p class="d-flex justify-content-between mb-2"><span class="date-content light-background">11th March, 2024 </span><span>2 days ago</span></p>
				  <h6>Requesting Approval<span class="dot-notification"></span></h6>
				  <p>Each of the results is important... </p>
				</div>
			  </li>
			</ul>
